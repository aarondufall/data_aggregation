...
function create-table {
  ...
  base=$(script_dir)
  psql $database -f $base/table/foo-table.sql
  psql $database -f $base/table/bar-table.sql
  psql $database -f $base/table/consumer-table.sql
  echo
}
